...
import xlrd
conn=mysql.connector.connect(host="localhost",user="root",passwd="Divya@123",database="attendance")
cur=conn.cursor()
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                q="""insert into students(Name,Time,status,date) values (%s, %s ,%s,%s)""" 
                                l=(name,current_time,'Clock In',current_date)
                                cur.execute(q,l)
                                conn.commit()
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                q="""insert into students(Name,Time,status,date) values (%s, %s ,%s,%s)""" 
                                l=(name,current_time,'Clock Out',current_date)
                                cur.execute(q,l)
                                conn.commit()
